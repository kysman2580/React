  ...
  return (
    <>
      ...
      <pre>
        ...
        JSX문법을 사용해서 JavaScript 코드 내부에서 React의 "Element"를
        생성할 수 있으며, JavaScript의 모든 기능을 이용할 수 있고, U.I를
        구현할 때 React와 함께 사용되길 권장됨
        <br />
        <br />
        ...
        <br />
        <br />
        React는 index.html파일 안에 있는 root라는 아이디 속성값을 가진 div요소
        안에서 모든 요소를 관리
